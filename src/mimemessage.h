...
public:
  ...
  bool setSender(const QString email, const QString &name); // формат ("test@test.com", "Jon Smitt")
  bool setSender(const QString &name_and_email);            // формат ("Jon Smitt <test@test.com>")
  bool addRcpt(const QString email, const QString &name);   // формат ("test@test.com", "Jon Smitt")
  bool addRcpt(const QString &name_and_email);              // формат ("Jon Smitt <test@test.com>")
